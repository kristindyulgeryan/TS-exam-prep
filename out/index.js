...
const dnaCodeLang_1 = require("./dnaCodeLang");
// Example 1
...
// Example 4
let dnaCharsLanguage = new dnaCodeLang_1.DNACodeLanguage();
let caesarCipher = new caesarCipher_1.CaesarCipher(dnaCharsLanguage);
let encoder = new languageMessageEncoder_1.LanguageMessageEncoder(dnaCharsLanguage, caesarCipher);
